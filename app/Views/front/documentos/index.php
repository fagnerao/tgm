  ...
  <div class="max-w-2xl mx-auto">
        <!-- search list form -->
            <form class="flex items-center mb-8" method="POST" >   
                ...
                <a href="<?= base_url('/documentos') ?>" class="p-2.5 ml-2 text-sm text-gray-900 font-medium bg-gray-200 rounded-lg border border-gray-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php foreach($documentos as $f) { ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?= $f->titulo ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?= $f->depName ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <!-- ACORDION ARQUIVOS -->
                                    <button type="button" class="btn-get-files flex items-center justify-between w-full p-5 font-medium text-left" data-id="<?= $f->id ?>">
                                        <span><i class="ri-search-eye-line"></i> Visualizar arquivos</span>
                                    </button>
                                        <ul class="text-gray-500 dark:text-gray-400 show-files-<?= $f->id ?>">
                                        </ul>
                                    </div>
                                </div>
                                <!-- final ARQUIVOS -->
